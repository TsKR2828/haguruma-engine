...
>
> ⚠ **本檔「主題」段落已作廢（audit §1c-7）：稻荷／狐狸信仰、義妹蓚酸毒殺為幻覺
> 內容，原文根本沒有這段——B:L488 該段實際是「避暑地也是世の中」（毒殺病人的醫生、
> 放火的老太婆、奪妹妹財產的律師），無稻荷、無狐狸、無草酸、無義妹。「飛行機病」
> 對白（B:L522／L526）的說話者已更正為妻の弟（speakerId: "wifes_brother"），非本檔
> 原先誤標的妻の母。場景切分以 `docs/ch6-source-map.md`（Batch F10，唯一施工圖來源）
> 為準，已實作於 `src/data/chapters/chapter06.js`（29 場景、4 選擇點）。**
...
1. ~~**原著只有六章**——CLAUDE.md 記載「原著 11 章 51 節」，但青空文庫文本只有六個標題章節。需確認：是否將六章拆分為更多遊戲章節？或修正 CLAUDE.md 的描述？~~ **已解決（2026-07-12）**：CLAUDE.md 已修正為「原著 6 章」（Batch 7 後續修正），不拆分——遊戲章節與原著章節一對一對應。其餘文件（ENGINE_SPEC.md / CHAPTER_GUIDE.md / DECISIONS.md）殘留的「11 章」敘述已於 Batch F4 Lane B 清理。
