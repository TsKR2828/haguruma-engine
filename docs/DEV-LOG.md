...
| 2026-05-07 | P1-fix | fix: add missing gear component dependencies | done | GearDefs / ActionBlock / ForcedSteps / GearOverlay |
| 2026-05-07 | P2C | feat: add left sidebar chapter navigation | done | LeftSidebar, expand/collapse TOC, forward-compatible image display |
