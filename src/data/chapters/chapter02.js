  ...
  scenes: {
    ...
    ch2_prologue: {
      ...
      text: [
        ...
        { type: "break" },
        {
          ...
          cn: "早上八點左右，我在這旅館的房間裡醒來。正要下床時，卻發現拖鞋不可思議地只剩一隻。這一兩年來，這種現象總是帶給我恐懼與不安。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "のみならずサンダアルを片っぽだけはいた希臘神話の中の王子を思い出させる現象だった。",
          cn: "不僅如此——這現象總讓我想起希臘神話裡，那位只穿了一隻涼鞋的王子。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "僕はベルを押して給仕を呼び、スリッパアの片っぽを探して貰うことにした。給仕はけげんな顔をしながら、狭い部屋の中を探しまわった。",
          cn: "我按了鈴，叫來給仕，要他去找拖鞋的另一隻。給仕面露狐疑，在狹小的房間裡找了一圈。",
        },
      ],
      choices: null,
    ...
    ch2_slipper_found: {
      ...
      text: [
        ...
        { type: "dialogue", origin: "source", speaker: "我", speakerId: "protagonist", jp: "「どうして又そんな所に行っていたのだろう？」", cn: "「怎麼又跑到那種地方去了呢？」" },
      ...
      text: [
        {
          type: "inner",
          origin: "added",
          content: "老鼠。我把這個詞和失蹤的拖鞋放在一起想了想——沒有結論，只是一種說不出的預感，開始在心裡打轉。",
        },
      ],
      choices: null,
      next: "ch2_morning_writing",
    ...
    ch2_brother_fires: {
      ...
      text: [
        ...
        },
        {
          ...
          cn: "但真正讓我不安的，與其說是他的自殺，不如說是——我每次回東京，必定會看見火在燃燒。",
        },
      ],
      choices: [
        {
      ...
      text: [
        {
          ...
          cn: "我曾從火車車廂裡，望見焚燒山林的火；也曾從汽車裡——那時妻兒都在車上——望見常磐橋一帶的火災。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "それは彼の家の焼けない前にもおのずから僕に火事のある予感を与えない訣には行かなかった。",
          cn: "在他家真正燒起來之前，那些火早就一次次，兀自給了我一種不祥的預感。",
        },
      ],
      choices: null,
      next: "ch2_fire_dialogue",
    ...
    ch2_fire_dialogue: {
      ...
      text: [
        { type: "narration", origin: "added", content: "那時，我曾這樣對妻子說過——" },
        { type: "dialogue", origin: "source", speaker: "我", speakerId: "protagonist", jp: "「今年は家が火事になるかも知れないぜ」", cn: "「今年家裡說不定也會失火呢。」" },
      ...
      text: [
        {
          ...
          cn: "然而，我的房子並沒有燒起來。——我努力把妄想推開，想再一次動筆。可筆尖，無論如何也難以順暢地寫下哪怕一行。我終於離開了書桌，往床上一躺，讀起了托爾斯泰的《波利庫什卡》。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "この小説の主人公は虚栄心や病的傾向や名誉心の入り交った、複雑な性格の持ち主だった。しかも彼の一生の悲喜劇は多少の修正を加えさえすれば、僕の一生のカリカテュアだった。",
          cn: "這部小說的主人公，是個虛榮心、病態傾向與名譽心交纏在一起、性格複雜的人物。而他一生的悲喜劇，只要稍加修正，便成了我一生的漫畫像。",
        },
        {
          type: "narration",
          origin: "source",
    ...
    ch2_rat_search: {
      ...
      text: [
        { type: "action", origin: "added", prompt: "追進浴室，開門搜索。" },
        {
          ...
          cn: "我一個箭步衝進浴室，推開門四下搜尋。可白色浴缸的陰影裡，連個老鼠的影子也沒有。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "僕は急に無気味になり、慌ててスリッパアを靴に換えると、人気のない廊下を歩いて行った。",
          cn: "我忽然感到一陣毛骨悚然，慌忙把拖鞋換成鞋子，走過那條空無一人的走廊。",
        },
      ],
      choices: null,
      next: "ch2_cookroom",
    ...
    ch2_cookroom: {
      ...
      text: [
        {
          ...
          cn: "走廊今天也一如往常，陰鬱得像座牢獄。我低垂著頭，在樓梯間上上下下，不知不覺就走進了廚房。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "コック部屋は存外明るかった。が、片側に並んだ竈は幾つも炎を動かしていた。僕はそこを通りぬけながら、白い帽をかぶったコックたちの冷やかに僕を見ているのを感じた。同時に又僕の堕ちた地獄を感じた。",
          cn: "廚房裡意外地明亮。可一側並排的爐灶，仍有好幾座竈火在跳動。我穿行其間，感覺到戴著白帽的廚師們正冷冷地看著我——同時，我也感覺到自己墮入的地獄。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "「神よ、我を罰し給え。怒り給うこと勿れ。恐らくは我滅びん」――こう云う祈祷もこの瞬間にはおのずから僕の脣にのぼらない訣には行かなかった。",
          cn: "「神啊，懲罰我吧。不要動怒。恐怕我將要滅亡」——這樣的禱詞，在這一瞬間，也不由自主地湧上了我的嘴唇。",
        },
      ],
      choices: null,
      ...
      flags: [],
      notebook: { key: "ch02.hell", symbol: "fire", desc: "廚房的爐火與白帽廚師的冷眼——我感到自己墮入的地獄" },
      ...
      text: [
        {
          ...
          cn: "這感覺帶給我的，與其說是不快，不如說更接近恐懼。我想起了但丁地獄裡，那些化作樹木的靈魂——",
        },
      ],
      choices: null,
      next: "ch2_fan",
      ...
      text: [
        {
          ...
          cn: "我打定主意，索性走到那滿是大樓、電車線路對面的那一側。可就連那一頭的一町路，也沒能平安走完。",
        },
        {
          type: "dialogue",
          origin: "source",
        ...
        },
        {
          ...
          cn: "那是個穿著金鈕扣制服、二十二三歲的青年。我默默地盯著這個青年看，發現他鼻子左側有一顆黑痣。他脫著帽子，怯生生地這樣向我搭話。",
        },
      ],
      choices: null,
    ...
    ch2_fan_dialogue: {
      ...
      text: [
        ...
        { type: "dialogue", origin: "source", speaker: "我", speakerId: "protagonist", jp: "「そうです」", cn: "「是的。」" },
        { type: "dialogue", origin: "source", speaker: "青年", speakerId: "fan_youth", jp: "「どうもそんな気がしたものですから、……」", cn: "「我就覺得，好像是您……」" },
        { type: "dialogue", origin: "source", speaker: "我", speakerId: "protagonist", jp: "「何か御用ですか？」", cn: "「有什麼事嗎？」" },
      ...
      text: [
        {
          type: "narration",
          origin: "added",
          content: "青年顯得侷促不安，話說到一半便沒有了下文。我終究還是——轉身走開了。",
        },
      ],
      choices: null,
      next: "ch2_sensei",
    ...
    ch2_sensei: {
      ...
      flags: [],
      notebook: { key: "ch02.nerves_only", symbol: "book", desc: "「我沒有任何良心，我有的只是神經」——兩三個月前我自己發表的話" },
    ...
    ch2_barrack: {
      ...
      text: [
        ...
        },
        {
          ...
          cn: "我們一面把手伸向火盆取暖，一面談了許多事。體格健壯的姊夫，本能地輕蔑著比常人瘦弱得多的我，甚至公然宣稱我的作品不道德。我總是冷冷地俯視著這樣的他，一次也不曾推心置腹地交談過。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "しかし姉と話しているうちにだんだん彼も僕のように地獄に堕ちていたことを悟り出した。彼は現に寝台車の中に幽霊を見たとか云うことだった。",
          cn: "可是與姊姊談著談著，我漸漸察覺到——他其實也和我一樣，早已墮入了地獄。據說他生前，確實曾在寢台車中看見過幽靈。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "が、僕は巻煙草に火をつけ、努めて金のことばかり話しつづけた。",
          cn: "但我點起了一支菸，只顧著儘量把話題扯到錢的事情上。",
        },
      ],
      choices: null,
      next: "ch2_money_talk",
    ...
    ch2_money_talk: {
      ...
      text: [
        ...
        { type: "dialogue", origin: "source", speaker: "我", speakerId: "protagonist", jp: "「それはそうだ。タイプライタアなどは幾らかになるだろう」", cn: "「那也好。像打字機這類東西，多少能換點錢吧。」" },
        { type: "dialogue", origin: "source", speaker: "姉", speakerId: "sister", jp: "「ええ、それから画などもあるし」", cn: "「嗯，還有畫之類的也是。」" },
        { type: "dialogue", origin: "source", speaker: "我", speakerId: "protagonist", jp: "「次手にＮさん（姉の夫）の肖像画も売るか？　しかしあれは……」", cn: "「順便把 Ｎ 先生（姊夫）的肖像畫也賣了？不過那幅……」" },
      ],
      choices: null,
      next: "ch2_portrait",
      effects: null,
      ...
      text: [
        {
          ...
          cn: "我望著木板房牆上，那幅沒有畫框的炭精畫像，忽然覺得連句玩笑話都無法輕率地說出口。",
        },
        {
          type: "narration",
          origin: "source",
      ...
      text: [
        {
          ...
          cn: "我猜想或許是光線的緣故，於是換了好幾個位置，細細打量著這幅炭精畫像。",
        },
      ],
      choices: null,
      next: "ch2_portrait_talk",
    ...
    ch2_portrait_talk: {
      ...
      text: [
        ...
        { type: "dialogue", origin: "source", speaker: "我", speakerId: "protagonist", jp: "「何でもないよ。……唯あの肖像画は口のまわりだけ、……」", cn: "「沒什麼。……只是那幅肖像畫，嘴巴周圍……」" },
        {
          type: "narration",
          origin: "source",
          jp: "姉はちょっと振り返りながら、何も気づかないように返事をした。",
          cn: "姊姊微微回過頭，用一種毫不在意的口吻回答我。",
        },
      ...
      text: [
        {
          ...
          cn: "然而，如果不是錯覺——我決定，在還沒被留下來吃午飯之前，就先離開姊姊家。",
        },
        { type: "dialogue", origin: "source", speaker: "姉", speakerId: "sister", jp: "「まあ、善いでしょう」", cn: "「哎，這樣也好吧。」" },
        { type: "dialogue", origin: "source", speaker: "我", speakerId: "protagonist", jp: "「又あしたでも、……きょうは青山まで出かけるのだから」", cn: "「改天再來吧……今天還得到青山去一趟呢。」" },
        { type: "dialogue", origin: "source", speaker: "姉", speakerId: "sister", jp: "「ああ、あすこ？　まだ体の具合は悪いの？」", cn: "「啊，那邊？身體還是不舒服嗎？」" },
        { type: "dialogue", origin: "source", speaker: "我", speakerId: "protagonist", jp: "「やっぱり薬ばかり嚥んでいる。催眠薬だけでも大変だよ。ヴェロナアル、ノイロナアル、トリオナアル、ヌマアル……」", cn: "「還是老樣子，只能靠藥撐著。光是安眠藥就夠受的了。維洛那爾、諾伊洛那爾、特里奧那爾、努馬爾……」" },
      ],
      choices: null,
      next: "ch2_restaurant",
      effects: null,
      ...
      text: [
        {
          ...
          cn: "約莫過了三十分鐘，我走進了某棟大樓，搭電梯上到三樓，想推開一間餐廳的玻璃門進去。可玻璃門卻紋絲不動——不僅如此，門上還掛著一塊寫著「公休日」的漆牌。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "僕は愈不快になり、硝子戸の向うのテエブルの上に林檎やバナナを盛ったのを見たまま、もう一度往来へ出ることにした。",
          cn: "我益發感到不快，望著玻璃門另一側桌上堆著的蘋果與香蕉，只得再次走回了大街上。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "すると会社員らしい男が二人何か快活にしゃべりながら、このビルディングにはいる為に僕の肩をこすって行った。彼等の一人はその拍子に「イライラしてね」と言ったらしかった。",
          cn: "這時，兩個像是上班族的男人一面興高采烈地說著什麼，一面擦著我的肩膀，走進了這棟大樓。其中一人似乎正好在那當口說了句「真讓人心煩吶」。",
        },
      ],
      choices: [
        {
          text: "那句『イライラしてね』黏在我耳裡。",
          next: "ch2_irritation",
      ...
      text: [
        {
          type: "inner",
          origin: "added",
          content: "「イライラしてね」——那句話黏在我耳邊，在腦中滾動打轉，卻還沒有凝成任何形狀。",
        },
      ],
      choices: null,
      next: "ch2_taxi",
    ...
    ch2_taxi: {
      ...
      text: [
        {
          ...
          cn: "我佇立在大街上，等著計程車經過。可計程車遲遲不來——不僅如此，偶爾駛過的，也必定是黃色的車。（不知為何，這種黃色計程車總是給我帶來交通事故般的麻煩）",
        },
        {
          type: "narration",
          origin: "source",
          jp: "そのうちに僕は縁起の好い緑いろの車を見つけ、とにかく青山の墓地に近い精神病院へ出かけることにした。",
          cn: "沒過多久，我發現了一輛吉利的綠色車，總算決定前往那間靠近青山墓地的精神病院。",
        },
      ],
      choices: null,
      next: "ch2_tantalus",
      effects: null,
      flags: [],
      notebook: { key: "ch02.yellow_taxi", symbol: "gear", desc: "黃色計程車＝交通事故的預兆；我等到了吉利的綠色車" },
    ...
    ch2_tantalus: {
      ...
      text: [
        ...
        },
        {
          ...
          cn: "坦塔羅斯——那其實正是我自己，隔著玻璃門凝視著水果的模樣。我一面咒罵著兩度浮上眼前的但丁地獄，一面死死盯著司機的背影。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "そのうちに又あらゆるものの噓であることを感じ出した。政治、実業、芸術、科学、――いずれも皆こう云う僕にはこの恐しい人生を隠した雑色のエナメルに外ならなかった。",
          cn: "漸漸地，我又感覺到——一切的一切都是謊言。政治、實業、藝術、科學——對如今的我而言，這些不過都是掩蓋這可怕人生的、五顏六色的琺瑯罷了。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "僕はだんだん息苦しさを感じ、タクシイの窓をあけ放ったりした。が、何か心臓をしめられる感じは去らなかった。",
          cn: "我漸漸感到呼吸困難，把計程車的車窗大大地敞開。可那種彷彿被扼住心臟的感覺，卻怎麼也揮之不去。",
        },
      ],
      choices: null,
      ...
      text: [
        {
          ...
          cn: "綠色計程車總算駛近了神宮前。那附近，本該有一條轉往那間精神病院的小巷。可不知為何，唯獨今天，我怎麼也找不到。我沿著電車軌道，讓計程車來回開了好幾趟，終於還是死心，下了車。",
        },
      ],
      choices: null,
      next: "ch2_saijo",
      ...
      text: [
        {
          ...
          cn: "我終於找到了那條小巷，拐進了一條泥濘不堪的路。可不知不覺又走錯了路，竟走到了青山齋場的門前。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "それはかれこれ十年前にあった夏目先生の告別式以来、一度も僕は門の前さえ通ったことのない建物だった。十年前の僕も幸福ではなかった。しかし少くとも平和だった。",
          cn: "那是自從約莫十年前，夏目先生的告別式以來，我連門前都不曾走過一次的建築。十年前的我，雖然稱不上幸福，至少還算平靜。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "僕は砂利を敷いた門の中を眺め、「漱石山房」の芭蕉を思い出しながら、何か僕の一生も一段落ついたことを感じない訣には行かなかった。",
          cn: "我望著鋪滿碎石的門內，想起「漱石山房」的那株芭蕉，不由得感覺到——自己的一生，似乎也已經告一段落了。",
        },
      ],
      choices: [
        {
          text: "去感受那個『把我帶到墓地前的什麼』。",
          next: "ch2_led_by",
          flag: "ch02.felt_led",
          effects: { insight: { amount: 1, reason: "被帶到墓地前的某種東西" } },
          notebook: { key: "ch02.led_by", symbol: "wing", desc: "十年後把我帶到青山墓地前的——某種東西" },
          unlock: "ch02.led_by",
        },
        {
          text: "快步找回正路。",
      ...
      text: [
        {
          ...
          cn: "不僅如此，我也不由得感覺到——是某種東西，在第十年，把我帶到了這座墓地前。",
        },
      ],
      choices: null,
      next: "ch2_hospital_return",
    ...
    ch2_hospital_return: {
      ...
      text: [
        {
          ...
          cn: "走出那間精神病院的大門後，我又搭上了汽車，決定回到方才那間旅館。可一到旅館的玄關前，卻見一個穿著雨衣的男人，正跟給仕吵著什麼。",
        },
        {
          type: "narration",
          origin: "source",
        ...
        },
        {
          ...
          cn: "我忽然對走進這間旅館，生出了某種不祥的預感，於是趕緊掉頭，順著原路走了回去。",
        },
      ],
      choices: null,
      next: "ch2_ginza",
      ...
      flags: [],
      notebook: { key: "ch02.raincoat_hotel", symbol: "raincoat", desc: "旅館玄關——穿雨衣的男人在與綠制服的車伕爭吵。我調頭離開" },
      ...
      text: [
        {
          ...
          cn: "當我走到銀座通時，天色差不多已近黃昏。兩旁林立的店鋪與絡繹不絕的人潮，讓我不由得更加憂鬱起來。尤其令我不快的，是路上的行人們，個個都像不知罪為何物似的，輕快地走著。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "僕は薄明るい外光に電燈の光のまじった中をどこまでも北へ歩いて行った。そのうちに僕の目を捉えたのは雑誌などを積み上げた本屋だった。僕はこの本屋の店へはいり、ぼんやりと何段かの書棚を見上げた。",
          cn: "我在微亮的天光與電燈燈光交雜之中，一路往北走去。這時，我的目光被一間堆滿雜誌的書店吸引住了。我走進這間書店，茫然地抬頭望著幾層書架。",
        },
        {
          type: "narration",
          origin: "source",
          jp: "それから「希臘神話」と云う一冊の本へ目を通すことにした。黄いろい表紙をした「希臘神話」は子供の為に書かれたものらしかった。けれども偶然僕の読んだ一行は忽ち僕を打ちのめした。",
          cn: "接著，我隨手翻閱起一本名為《希臘神話》的書。這本封面黃色的《希臘神話》，看來是為孩子寫的。可我偶然讀到的那一行，卻瞬間把我擊垮了。",
        },
      ],
      choices: null,
      next: "ch2_zeus",
      ...
      text: [
        {
          ...
          cn: "我把這間書店拋在身後，走進了人潮之中。不知不覺已然彎曲的背脊上，我始終感覺到——那復仇之神，正不斷地緊追不捨、窺伺著我。……",
        },
